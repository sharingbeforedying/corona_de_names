...
exports.MyRoom = class extends colyseus.Room {
  ...
  onMessage (client, message) {
    ...
    //session
      ...
      try {
        ...
        this.send(client, { command : command, payload : formModel });
      } catch(error) {
        this.send(client, { command : command, error: error });
      }
    }
      ...
      try {
        ...
        this.send(client, { command : command, payload : session });
      } catch(error) {
        this.send(client, { command : command, error: error });
      }
  ...
  onLeave (client, consented) {
    ...
    this.state.removeGroupPlayerGroup(client.sessionId);
