...
const GroupEquipment = require("./GroupEquipment.js").GroupEquipment;

exports.ClientRoomA1 = class ClientRoomA1 extends ClientRoom {
  ...
  addEquipment(eqptName, eqpt) {
    ...
    console.log("JSON.stringify(eqpt.initialState)", JSON.stringify(eqpt.initialState));
  ...
  handleMessage (client, message) {
    ...
    console.log("ClientRoomA1", "onMessage", this.roomName);
