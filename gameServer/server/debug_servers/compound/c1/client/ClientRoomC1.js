...
const CreateSessionEquipment = require("./CreateSessionEquipment.js").CreateSessionEquipment;

exports.ClientRoomC1 = class ClientRoomC1 extends ClientRoom {
  ...
  handleMessage (client, message) {
    ...
    console.log("ClientRoomC1", "onMessage", this.roomName);
