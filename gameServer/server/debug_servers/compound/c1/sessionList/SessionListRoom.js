...
const SessionListRoomState = require("./SessionListRoomState.js").SessionListRoomState;

exports.SessionListRoom = class SessionListRoom extends SharedRoom {

  constructor(presence) {
    super(presence);

    const state = new SessionListRoomState();
