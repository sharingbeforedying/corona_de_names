...
exports.InstanceSector = class InstanceSector {
  ...
  //     const cnPlayerRole = require('../../../../_game/game/instance/InstancePlayerRole.js').cnPlayerRole;
  //
  //     var roomNickname = "instanceEndxxx";
  //
  //     switch(role.id) {
  //       case cnPlayerRole.TELLER:
  //         roomNickname += "_" + "T";
  ...
  createGame(teamsConfigWrapper, contentConfig) {
    ...
    const game = new Game_cnduo(teamsConfigWrapper);
...

    {
      ...
      game.rx_everyoneIsGuesserPhase.subscribe({
        next(turn) {
          console.log("rx_guesserPhase", "next");
          // // sector.instanceTellerRoom_1.state.turn  = turn.createEcho();
          // sector.instanceGuesserRoom_1.state.turn = turn.createEcho();
...

    {
      ...
      var position_grid = game.gameState.position_grid__red;
      this.instanceTellerRoom_1.setupGrid_position(position_grid.createEcho());
      ...
      this.instanceGuesserRoom_1.setupGrid_position(game.gameState.position_grid__blue.createEcho());
...

    {
      ...
      this.instanceTellerRoom_2.setupGrid_position(position_grid.createEcho());
      ...
      // this.instanceGuesserRoom_2.setupGrid_position(game.gameState.position_grid);
      this.instanceGuesserRoom_2.setupGrid_position(game.gameState.position_grid__red.createEcho());
