...
const InstanceTellerRoomState = require("./InstanceTellerRoomState.js").InstanceTellerRoomState;

exports.InstanceTellerRoom = class SessionRoom extends SharedRoom {

  constructor(presence) {
    super(presence);

    const state = new InstanceTellerRoomState();
  ...
  setupCommandHandlers(commandLibrary, game) {
    ...
    const TellerHint   = require("../../../../../_game/game/instance/actions/TellerHint.js").TellerHint;
    ...
    const commandHandler__instance_teller_submitHint = new CommandHandler("instance_teller_submitHint", "instance_teller_submitHint", (client, message) => {
      const [command, data] = message;
      ...
      game.manageTellerAction(playerAction);
    });
    commandLibrary.addCommandHandler(commandHandler__instance_teller_submitHint);
