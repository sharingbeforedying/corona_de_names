...
class InstanceTellerRoomState extends RoomState {
    constructor () {
        super(false, 131);
        // this.roomType = 131;
...
schema.defineTypes(InstanceTellerRoomState, {
...
exports.InstanceTellerRoomState = InstanceTellerRoomState;
