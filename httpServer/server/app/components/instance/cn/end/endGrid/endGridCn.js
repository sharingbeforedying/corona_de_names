(function () {
  ...
  angular.module("awApp").component('endGridCn', {
      templateUrl: 'app/components/instance/cn/end/endGrid/endGridCn.html',
      controller: EndGridController,
  ...
  EndGridController.$inject = ['$scope', '$state', 'navigationService'];
  function EndGridController($scope, $state, navigationService) {
      var vm = this;
      // vm.localId = "";
      // vm.connect = () => serverService.connect();

      console.log("EndGridController");

      vm.$onInit = function() {
        console.log("EndGridController::$onInit");
