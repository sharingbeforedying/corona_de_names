(function () {
  ...
  angular.module("awApp").component('guesserGridCn', {
      templateUrl: 'app/components/instance/cn/guesser/guesserGrid/guesserGridCn.html',
  ...
  function GuesserGridController($scope, $state, navigationService) {
      var vm = this;
      // vm.localId = "";
