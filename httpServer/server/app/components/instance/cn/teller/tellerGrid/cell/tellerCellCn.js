(function () {
  ...
  angular.module("awApp").component('tellerCellCn', {
      templateUrl: 'app/components/instance/cn/teller/tellerGrid/cell/tellerCellCn.html',
  ...
  TellerCellController.$inject = ['displaySettingsService', '$scope'];
  function TellerCellController(displaySettingsService, $scope) {
      var vm = this;
      // vm.localId = "";
