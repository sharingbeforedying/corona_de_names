(function () {
  ...
  angular.module('awApp').component('imageFolderInput', {
    templateUrl: 'app/shared/components/image/imageFolderInput/imageFolderInput.html',
    controller: ImageFolderInputController,
    bindings: {
      nbItems:  "<",
      itemSize: "<",
      randomPick: "<",
  ...
  ImageFolderInputController.$inject = ["$scope"];
  function ImageFolderInputController($scope) {
    var ctrl = this;

    ctrl.$onInit = function() {
      console.log("ImageFolderInputController", "$onInit");
