...
export class InstanceGuesserRoomService extends AbsRoomService {
...
// // const rx_cells_change =  new Rx.Subject();
// const rx_cells_previous = new ReplaySubject(1);
// // rx_cells_previous.next(room.state.grid_game.cells);
// rx_cells_previous.next(angular.copy(room.state.grid_game.cells));
//
//
// room.state.grid_game.onChange = (changes) => {
//   changes.forEach(change => {
//       console.log("room.state.grid_game.onChange");
//       console.log(change.field);
//       console.log(change.previousValue);
//       console.log(change.value);
//
...
//
//       } else if(change.field == "cells") {
//         // this.cells_previous = change.previousValue;
//
//         // rx_cells_change.next({
//         //   prevv: change.previousValue,
//         //   newv:  change.value,
//         // });
//
//         // rx_cells_previous.next(change.value);
//         rx_cells_previous.next(angular.copy(change.value));
//
//
//       }
//
...
//
//
// // const rx_cell_prettyChange = Rx.zip(rx_cells_change, rx_cell_change);
// //
// // rx_cell_prettyChange.subscribe({
// //   next([mother_change, child_change]) {
// //     console.log('rx_cell_prettyChange', 'mother_change', mother_change);
// //     console.log('rx_cell_prettyChange', 'child_change', child_change);
// //
// //     const cells_previous = mother_change.prevv;
// //     const cells_new      = mother_change.newv;
// //
// //     const change_key     = child_change.key;
// //
// //     const cell_previous  = cells_previous[change_key];
// //     const cell_new       = child_change.value;
// //     manageCellChange(change_key, cell_previous, cell_new);
// //
// //   },
// //   error(err) { console.error('rx_cell_prettyChange', 'something wrong occurred: ' + err); },
// //   complete() { console.log('rx_cell_prettyChange', 'done'); }
// // });
//
// const rx_cell_prettyChange = Rx.zip(rx_cells_previous, rx_cell_change);
//
// rx_cell_prettyChange.subscribe({
//   next([mother_previous, child_change]) {
//     console.log('rx_cell_prettyChange', 'mother_previous', mother_previous);
//     console.log('rx_cell_prettyChange', 'child_change', child_change);
//
//     const change_key     = child_change.key;
//
//     const cell_previous  = mother_previous[change_key];
//     const cell_new       = child_change.value;
//     manageCellChange(change_key, cell_previous, cell_new);
//
//   },
...
// });
//
// function manageCellChange(cellIndex, prev, cell) {
//   console.log("manageCellChange", cellIndex, prev, cell);
//
// }
